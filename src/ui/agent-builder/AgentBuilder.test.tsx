...
describe('AgentBuilder', () => {
  it('Tool選択から草案生成・編集・version保存まで行う', async () => {
    const client = {
      ...
      runSavedAgent: vi.fn().mockResolvedValue({ runId: 'run-1', mode: 'preview', response: 'done', trace: [{ sequence: 1, kind: 'model-response', content: 'done' }], usage: {}, agent: { internalId: 'assistant-agent', version: '1.0.0' } }),
