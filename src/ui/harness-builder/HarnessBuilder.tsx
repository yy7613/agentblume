...
const patterns: readonly { readonly id: HarnessPatternDto; readonly label: string; readonly note: string }[] = [
  ...
  { id: 'handoff', label: 'Handoff', note: 'Transfer ownership through allowed routes' },
  { id: 'group-chat', label: 'Group Chat', note: 'Select speakers across bounded rounds' },
  { id: 'magentic', label: 'Magentic', note: 'Manager plans, delegates, and synthesizes' },
];
