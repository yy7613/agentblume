      ...
      <div className="evaluation-editors">
        <section className="workspace-card" aria-label={text('Dataset editor', 'データセット編集')}>
          ...
          <div className="agent-fields">
            ...
            <label>{text('Owner', '所有者')}<input aria-label="Dataset owner" value={owner} onChange={(event) => setOwner(event.target.value)} /></label>
          </div>
