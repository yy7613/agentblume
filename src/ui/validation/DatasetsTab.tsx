  ...
  return <>
    ...
    <div className="two-column-workspace">
      ...
      <div className="evaluation-editors">
        ...
        <section className="workspace-card" id="judge-rubric-editor" aria-label={text('Judge rubric editor', 'Judge Rubric編集')}>
