...
export interface AgentHarnessRepository {
  ...
  findVersion(scope: TenantScope, internalId: HarnessId, version: SemVer): Promise<AgentHarness | null>;
  findLatest(scope: TenantScope, internalId: HarnessId): Promise<AgentHarness | null>;
  listVersions(scope: TenantScope, internalId: HarnessId): Promise<SemVer[]>;
   ...
   */
  delete(scope: TenantScope, internalId: HarnessId): Promise<boolean>;
}
