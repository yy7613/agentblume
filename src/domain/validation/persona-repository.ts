...
export interface PersonaRepository {
  ...
  findVersion(scope: TenantScope, internalId: PersonaId, version: SemVer): Promise<Persona | null>;
  findLatest(scope: TenantScope, internalId: PersonaId): Promise<Persona | null>;
  listVersions(scope: TenantScope, internalId: PersonaId): Promise<SemVer[]>;
   ...
   */
  delete(scope: TenantScope, internalId: PersonaId): Promise<boolean>;
}
