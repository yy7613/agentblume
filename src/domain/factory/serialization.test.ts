    ...
    iterations: [
      {
        ...
        metrics: { iteration: 1, goalAchievedRate: 0.5, avgSatisfaction: 3, toolHitRate: 0.8, errorRate: 0, avgUserTurns: 3, scenarioCount: 4, surveyMissingCount: 0, usage: { promptTokens: 10, completionTokens: 20, totalTokens: 30 }, durationMs: 1000 },
        analysis: {
      ...
      },
      {
        ...
        agentVersion: '0.2.0',
        scenarioRunIds: ['sr-3'],
        metrics: { iteration: 2, goalAchievedRate: 0.9, avgSatisfaction: 4.5, toolHitRate: 1, errorRate: 0, avgUserTurns: 2, scenarioCount: 4, surveyMissingCount: 0, usage: {}, durationMs: 500 },
      },
    ],
    report: { bestIteration: 2, candidate: { agentId: 'agent-1', version: '0.2.0' }, summary: '目標達成', openFindings: [{ id: 'f2', severity: 'info', area: 'scenario', detail: '軽微な指摘' }], metricsByIteration: [{ iteration: 1, goalAchievedRate: 0.5, avgSatisfaction: 3, toolHitRate: 0.8, errorRate: 0, avgUserTurns: 3, scenarioCount: 4, surveyMissingCount: 0, usage: {}, durationMs: 1000 }], quality: 'met-targets', qualityReasons: [] },
