...
import { createJudgeRubric, type JudgeCriterion, type JudgeReferencePolicy, type JudgeRubric, type JudgeTracePolicy } from '../../domain/evaluation/judge-rubric';
import type { TenantScope } from '../../domain/shared/tenant-scope';
import type { PublishState } from '../../domain/tool/metadata';
import { SemVer } from '../../domain/tool/semver';

export interface SaveJudgeRubricInput {
  readonly scope: TenantScope; readonly internalId: JudgeRubricId; readonly workingName: string; readonly displayName: string; readonly publishName: string; readonly owner: string;
  readonly instructions: string; readonly criteria: readonly JudgeCriterion[]; readonly referencePolicy: JudgeReferencePolicy; readonly tracePolicy?: JudgeTracePolicy; readonly bump?: 'major' | 'minor' | 'patch'; readonly state?: PublishState;
}
