...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/evaluation-datasets': apiTarget,
      '/evaluator-profiles': apiTarget,
      '/experiments': apiTarget,
      '/experiment-comparisons': apiTarget,
      '/gate-policies': apiTarget,
      '/gate-reports': apiTarget,
      '/judge-rubrics': apiTarget,
      '/promotion-requests': apiTarget,
      '/runtime': apiTarget,
      '/wiki': apiTarget,
      '/wikis': apiTarget,
      '/memory': apiTarget,
